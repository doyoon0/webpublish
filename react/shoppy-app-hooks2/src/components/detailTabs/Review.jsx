...
import { axiosData, dataFetch } from '../../utils/dataFetch.js'
            ...
            <ul className='review-top-list'>
                <li>
                    <div>
                        ...
                        <StarRating totalRate={3.0} style="star-black-big" />
                    </div>
                </li>
                {data.topList && data.topList.map(item =>
                    <li>
                        <ReviewType title={item.title} names={item.names} values={item.values} />
                    </li>
                )}
            </ul>
...
/**
 * ProductDetail > Review > RevieList > ReviewListItem
 */
    ...
    return (
        <div className='review-list-item'>
            ...
            <ul className='pdt_review_photo'>
                <li>
                    <img src="https://media.wconcept.co.kr/review/307329760/307329760_1758465819068.jpeg?RS=300" alt="" />
                </li>
            </ul>
